...
Examples:
  ...
  python -m train.test --device cpu
    ...
    print(f"✅ Modelo carregado! Parâmetros: {sum(p.numel() for p in model.parameters()) / 1e6:.1f}M")
