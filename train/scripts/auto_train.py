...
class AutoTrainer:
    def __init__(self):
        ...
        self.train_root = self.script_dir.parent if self.script_dir.name == "scripts" else self.script_dir
    ...
    def validate_dataset(self) -> None:
        ...
        if not pinyin_link.exists():
            ...
            print_success(f"Symlink criado: f5_dataset_pinyin -> f5_dataset")
        ...
        with open(env_file, 'r') as f:
            for line in f:
                if line.startswith('PRETRAIN_MODEL_PATH='):
                    lines.append('PRETRAIN_MODEL_PATH=train/pretrained/F5-TTS-pt-br/pt-br/model_200000_fixed.pt\n')
