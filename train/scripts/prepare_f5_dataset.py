...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('train/logs/prepare_f5_dataset.log'),
...
def main():
    ...
    # Ler metadata.csv
    logger.info(f"📄 Lendo metadata.csv...")
    ...
    base_vocab_paths = [
        ...
        Path.home() / ".cache" / "huggingface" / "hub" / "models--firstpixel--F5-TTS-pt-br" / "snapshots" / "vocab.txt"
    ]
