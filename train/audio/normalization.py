...
def create_loudness_meter(sample_rate: int) -> object | None:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--target-lufs", type=float, default=-20.0, help="Target LUFS level (default: -20.0)"
    )
    parser.add_argument(
        "--method",
        choices=["lufs", "rms"],
    ...
    parser.add_argument("--stats", action="store_true", help="Show loudness statistics")
