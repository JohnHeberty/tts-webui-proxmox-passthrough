...
if __name__ == "__main__":
    ...
    convert_parser.add_argument('--sample-rate', type=int,
                               help='Target sample rate')
    convert_parser.add_argument('--mono', action='store_true',
    ...
    extract_parser.add_argument('--start', type=float, required=True,
                               help='Start time in seconds')
    extract_parser.add_argument('--end', type=float, required=True,
                               help='End time in seconds')
    extract_parser.add_argument('--sample-rate', type=int,
                               help='Target sample rate')
