...
if __name__ == "__main__":
    ...
    download_parser.add_argument('--sample-rate', type=int, default=24000,
    ...
    batch_parser.add_argument('--prefix', default='video',
                             help='Filename prefix (default: video)')
    batch_parser.add_argument('--sample-rate', type=int, default=24000,
                             help='Sample rate in Hz (default: 24000)')
