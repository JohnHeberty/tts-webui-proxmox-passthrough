# WebUI – Plano de Sprints para Correções e Melhorias

**Baseado em:** `MORE_WEBUI.md` (Relatório de Auditoria 2025-12-07)  
**Objetivo:** Resolver bugs críticos, melhorar arquitetura e UX da tela de Training

---

## Sprint 0 – Correções Emergenciais (P0) ⚡
**Duração:** 2-4 horas  
**Meta:** Fazer inferência funcionar AGORA
